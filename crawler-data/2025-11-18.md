...
TL;DR: DocLens是一个工具增强的多智能体框架，通过类似镜头的方式放大证据，从完整文档导航到特定页面上的视觉元素，使用采样裁决机制生成可靠答案，在多个基准测试中达到最先进性能。


<details>
  <summary>Details</summary>
Motivation: 现有视觉语言模型在理解长视觉文档时面临证据定位的根本挑战，无法有效检索相关页面并忽略视觉元素中的细粒度细节，导致性能有限和模型幻觉。
